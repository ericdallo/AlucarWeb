	...
	<div class='container'>
		...
		<div class="row row-margin">
			<div class="col-md-6 col-md-offset-3 text-center">
				<img style='width:300px !important;' src='<c:url value="/images/404.png"/>' />
			</div>
		</div>

		<div class='row row-margin'>
			<h3 class='text-center'>
				<fmt:message key="404.desc" />
			</h3>

			<div class="col-md-6 col-md-offset-3 text-center" role="group" aria-label="...">
				<a href='<c:url value="/home" />'  class="btn btn-primary"><fmt:message key="404.button" /></a>
			</div>
		</div>
	</div>

		...
		<c:forEach items="${cars}" var="car">
			<div class="row car-row">
				<div class="col-xs-8 col-xs-offset-2 card">
					<div class="image-car">
						<a href="<c:url value='/automovel/${car.id}'/>"> <img src="${car.image}" alt="Image">
						</a>
					</div>
					...
					<div class="footer">
						<span class="pull-right buttons"> <a href="<c:url value='/automovel/${car.id}'/>"
							class="btn btn-sm btn-default" role="button"> <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
								Visualizar
						</a> 
						<a href='<c:url value="/locacao?carId=${car.id}"/>' class='btn btn-sm btn-primary'>

...
public class GUIAutomovel extends JDialog implements ActionListener {
   ...
   public void init(JFrame fr){    
      ...
      //String[] opcoes4 = {"Selecione o Acessório","Navegador GPS","Cadeira de Bebê","Motorista"};
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      //ONCHANGE DO COMBOBOX DE PESQUISA
         ...
         //HABILITAR EDIÇÃO
            ...
            else if(status.equals("a") || status.equals("+")){//ESTOU ALTERANDO OS DADOS - CANCELAR ALTERAÇÃO
